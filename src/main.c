...
#define BME280_OSRS_P16 0x3
#define BME280_OSRS_T16 0b101
#define BME280_MODE_NORMAL 0b11
#define BME280_CTRL_HUM 0xF2
#define BME280_OSRS_H16 0b101
#define BME280_PRESSURE ((uint8_t)0xF7)
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  HAL_Delay(10);
	  HAL_UART_Transmit(&huart3, dataBuffer,3,1000);
	  //HAL_UART_Transmit(&huart3, test, 11, 1000);
	  /*
	  for(int i=1500; i<7500;i++){
		  TIM1->CCR1=i;
		  HAL_Delay(10);
	  }
	  for(int i=7500; i>1500;i--){
		 TIM1->CCR1=i;
	  	 HAL_Delay(10);
	  } */
    /* USER CODE END WHILE */
...
int32_t BME280_write_reg( uint8_t reg, uint8_t *data, uint8_t len){
    HAL_I2C_Mem_Write(&hi2c2, (BME280_I2C_ADDRESS<<1), reg,1, data, len,100);
